...
(defproject oasys_corp "1.0.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.5.0-RC16"]
                 ...
                 [ring/ring-json "0.1.2" :exclusions [cheshire]]
...
;                 [clj-pdf "0.9.1"]
                 ...
                 [ch.qos.logback/logback-access "1.0.7"]
                 [ch.qos.logback/logback-site "1.0.7"]
                 ;;;;;;;;;;;;;;;;; QUEUE  ;;;;;;;;;;;;;;;;;;
...
;             "-Dhttps.proxyPort=80"]
  :jvm-opts ["-Xmx128M" "-server" "-Xms128m" "-XX:MaxPermSize=128m"
