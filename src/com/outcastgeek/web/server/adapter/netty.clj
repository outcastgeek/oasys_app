...
;https://github.com/datskos/ring-netty-adapter/raw/master/src/ring/adapter/netty.clj
;
(ns com.outcastgeek.web.server.adapter.netty
  (:use com.outcastgeek.web.server.adapter.plumbing)
...
(defn- create-server [options handler]
  (let [bootstrap (ServerBootstrap. (NioServerSocketChannelFactory.
	...
	bootstrap (doto bootstrap
        ...
        (.setOption "receiveBufferSize" (* 128 1024))
        (.setOption "sendBufferSize" (* 128 1024)))]
    bootstrap))
