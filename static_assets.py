...
JS_VENDOR = path.join(path.dirname(__file__), 'resources/public/static/javascript/src/vendor')
JS_DEPLOY = path.join(path.dirname(__file__), 'resources/public/static/javascript')
CSS_DEPLOY = path.join(path.dirname(__file__), 'resources/public/static/stylesheets')
