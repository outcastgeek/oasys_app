...
class Employee(CRUDMixin, Base):
    ...
    groups = relationship("Group", cascade="all, delete-orphan", secondary='employee_group', backref="employees")
    projects = relationship("Project", cascade="all, delete-orphan", secondary='employee_project', backref="employees")
