...
var G__12039 = null;
var G__12039__2 = (function (self__,k){
var self____$1 = this;
var this$ = self____$1;
return cljs.core._lookup.call(null,this$,k);
});
var G__12039__3 = (function (self__,k,not_found){
var self____$1 = this;
var this$ = self____$1;
...
;
jQuery.prototype.apply = (function (self__,args12038){
return self__.call.apply(self__,[self__].concat(args12038.slice()));
});
...
var hide__delegate = function ($elem,p__12040){
var vec__12042 = p__12040;
var speed = cljs.core.nth.call(null,vec__12042,0,null);
var on_finish = cljs.core.nth.call(null,vec__12042,1,null);
return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__12040 = null;
if (arguments.length > 1) {
  p__12040 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return hide__delegate.call(this, $elem, p__12040);
};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__12043){
var $elem = cljs.core.first(arglist__12043);
var p__12040 = cljs.core.rest(arglist__12043);
return hide__delegate($elem, p__12040);
});
...
var show__delegate = function ($elem,p__12044){
var vec__12046 = p__12044;
var speed = cljs.core.nth.call(null,vec__12046,0,null);
var on_finish = cljs.core.nth.call(null,vec__12046,1,null);
return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__12044 = null;
if (arguments.length > 1) {
  p__12044 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return show__delegate.call(this, $elem, p__12044);
};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__12047){
var $elem = cljs.core.first(arglist__12047);
var p__12044 = cljs.core.rest(arglist__12047);
return show__delegate($elem, p__12044);
});
...
var toggle__delegate = function ($elem,p__12048){
var vec__12050 = p__12048;
var speed = cljs.core.nth.call(null,vec__12050,0,null);
var on_finish = cljs.core.nth.call(null,vec__12050,1,null);
return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__12048 = null;
if (arguments.length > 1) {
  p__12048 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return toggle__delegate.call(this, $elem, p__12048);
};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__12051){
var $elem = cljs.core.first(arglist__12051);
var p__12048 = cljs.core.rest(arglist__12051);
return toggle__delegate($elem, p__12048);
});
...
var fade_out__delegate = function ($elem,p__12052){
var vec__12054 = p__12052;
var speed = cljs.core.nth.call(null,vec__12054,0,null);
var on_finish = cljs.core.nth.call(null,vec__12054,1,null);
...
return fade_out__delegate.call(this, $elem, p__12052);
};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__12055){
var $elem = cljs.core.first(arglist__12055);
var p__12052 = cljs.core.rest(arglist__12055);
return fade_out__delegate($elem, p__12052);
});
...
var fade_in__delegate = function ($elem,p__12056){
var vec__12058 = p__12056;
var speed = cljs.core.nth.call(null,vec__12058,0,null);
var on_finish = cljs.core.nth.call(null,vec__12058,1,null);
return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__12056 = null;
if (arguments.length > 1) {
  p__12056 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_in__delegate.call(this, $elem, p__12056);
};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__12059){
var $elem = cljs.core.first(arglist__12059);
var p__12056 = cljs.core.rest(arglist__12059);
return fade_in__delegate($elem, p__12056);
});
...
var slide_up__delegate = function ($elem,p__12060){
var vec__12062 = p__12060;
var speed = cljs.core.nth.call(null,vec__12062,0,null);
var on_finish = cljs.core.nth.call(null,vec__12062,1,null);
return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__12060 = null;
if (arguments.length > 1) {
  p__12060 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_up__delegate.call(this, $elem, p__12060);
};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__12063){
var $elem = cljs.core.first(arglist__12063);
var p__12060 = cljs.core.rest(arglist__12063);
return slide_up__delegate($elem, p__12060);
});
...
var slide_down__delegate = function ($elem,p__12064){
var vec__12066 = p__12064;
var speed = cljs.core.nth.call(null,vec__12066,0,null);
var on_finish = cljs.core.nth.call(null,vec__12066,1,null);
...
return slide_down__delegate.call(this, $elem, p__12064);
};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__12067){
var $elem = cljs.core.first(arglist__12067);
var p__12064 = cljs.core.rest(arglist__12067);
return slide_down__delegate($elem, p__12064);
});
...
var closest__delegate = function ($elem,selector,p__12068){
var vec__12070 = p__12068;
var context = cljs.core.nth.call(null,vec__12070,0,null);
return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__12068 = null;
if (arguments.length > 2) {
  p__12068 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return closest__delegate.call(this, $elem, selector, p__12068);
};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__12071){
var $elem = cljs.core.first(arglist__12071);
arglist__12071 = cljs.core.next(arglist__12071);
var selector = cljs.core.first(arglist__12071);
var p__12068 = cljs.core.rest(arglist__12071);
return closest__delegate($elem, selector, p__12068);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__12074){
var map__12076 = p__12074;
var map__12076__$1 = ((cljs.core.seq_QMARK_.call(null,map__12076))?cljs.core.apply.call(null,cljs.core.hash_map,map__12076):map__12076);
var request = map__12076__$1;
var contentType = cljs.core.get.call(null,map__12076__$1,"\uFDD0:contentType");
var data = cljs.core.get.call(null,map__12076__$1,"\uFDD0:data");
var ct = jayq.core.__GT_content_type.call(null,contentType);
return (function (p1__12073_SHARP_){
if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__12073_SHARP_,"\uFDD0:data",cljs.core.pr_str.call(null,data));
} else
{return p1__12073_SHARP_;
}
}).call(null,(function (p1__12072_SHARP_){
if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__12072_SHARP_,"\uFDD0:contentType",ct);
} else
...
;
jayq.core.xhr = (function xhr(p__12077,content,callback){
var vec__12079 = p__12077;
var method = cljs.core.nth.call(null,vec__12079,0,null);
var uri = cljs.core.nth.call(null,vec__12079,1,null);
...
var unbind__delegate = function ($elem,ev,p__12080){
var vec__12082 = p__12080;
var func = cljs.core.nth.call(null,vec__12082,0,null);
return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__12080 = null;
if (arguments.length > 2) {
  p__12080 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return unbind__delegate.call(this, $elem, ev, p__12080);
};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__12083){
var $elem = cljs.core.first(arglist__12083);
arglist__12083 = cljs.core.next(arglist__12083);
var ev = cljs.core.first(arglist__12083);
var p__12080 = cljs.core.rest(arglist__12083);
return unbind__delegate($elem, ev, p__12080);
});
...
var on__delegate = function ($elem,events,p__12084){
var vec__12086 = p__12084;
var sel = cljs.core.nth.call(null,vec__12086,0,null);
var data = cljs.core.nth.call(null,vec__12086,1,null);
var handler = cljs.core.nth.call(null,vec__12086,2,null);
return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__12084 = null;
if (arguments.length > 2) {
  p__12084 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return on__delegate.call(this, $elem, events, p__12084);
};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__12087){
var $elem = cljs.core.first(arglist__12087);
arglist__12087 = cljs.core.next(arglist__12087);
var events = cljs.core.first(arglist__12087);
var p__12084 = cljs.core.rest(arglist__12087);
return on__delegate($elem, events, p__12084);
});
...
var one__delegate = function ($elem,events,p__12088){
var vec__12090 = p__12088;
var sel = cljs.core.nth.call(null,vec__12090,0,null);
var data = cljs.core.nth.call(null,vec__12090,1,null);
var handler = cljs.core.nth.call(null,vec__12090,2,null);
return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__12088 = null;
if (arguments.length > 2) {
  p__12088 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return one__delegate.call(this, $elem, events, p__12088);
};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__12091){
var $elem = cljs.core.first(arglist__12091);
arglist__12091 = cljs.core.next(arglist__12091);
var events = cljs.core.first(arglist__12091);
var p__12088 = cljs.core.rest(arglist__12091);
return one__delegate($elem, events, p__12088);
});
...
var off__delegate = function ($elem,events,p__12092){
var vec__12094 = p__12092;
var sel = cljs.core.nth.call(null,vec__12094,0,null);
var handler = cljs.core.nth.call(null,vec__12094,1,null);
return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__12092 = null;
if (arguments.length > 2) {
  p__12092 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return off__delegate.call(this, $elem, events, p__12092);
};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__12095){
var $elem = cljs.core.first(arglist__12095);
arglist__12095 = cljs.core.next(arglist__12095);
var events = cljs.core.first(arglist__12095);
var p__12092 = cljs.core.rest(arglist__12095);
return off__delegate($elem, events, p__12092);
});
...
done.cljs$lang$applyTo = (function (arglist__12096){
var deferred = cljs.core.first(arglist__12096);
var fns_args = cljs.core.rest(arglist__12096);
...
fail.cljs$lang$applyTo = (function (arglist__12097){
var deferred = cljs.core.first(arglist__12097);
var fns_args = cljs.core.rest(arglist__12097);
...
always.cljs$lang$applyTo = (function (arglist__12098){
var deferred = cljs.core.first(arglist__12098);
var fns_args = cljs.core.rest(arglist__12098);
