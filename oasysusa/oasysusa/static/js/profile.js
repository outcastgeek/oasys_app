...
cljs.core.with_meta = function with_meta(b, c) {
  return function() {
    ...
    "undefined" === typeof cljs.core.t4040 && (cljs.core.t4040 = {}, cljs.core.t4040 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta4041 = g;
    ...
    }, cljs.core.t4040.cljs$lang$type = !0, cljs.core.t4040.cljs$lang$ctorStr = "cljs.core/t4040", cljs.core.t4040.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t4040")
    }, cljs.core.t4040.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t4040.prototype.apply = function(b, c) {
      b = this;
      return b.call.apply(b, [b].concat(c.slice()))
    }, cljs.core.t4040.prototype.cljs$core$Fn$ = !0, cljs.core.t4040.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta4041
    }, cljs.core.t4040.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t4040(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t4040 = function(b, c, f, g) {
      return new cljs.core.t4040(b, c, f, g)
    });
    return new cljs.core.t4040(c, b, with_meta, null)
...
oasysusa.profile.profile_state = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
oasysusa.profile.update = function(a) {
  return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(oasysusa.profile.profile_state, a)
};
oasysusa.profile.reset = function() {
  return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(oasysusa.profile.profile_state, cljs.core.PersistentArrayMap.EMPTY)
};
oasysusa.profile.is_unchanged = function(a) {
  return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(oasysusa.profile.profile_state), a)
};
...
var G__4243_4245 = angular.module.call(null, "profile", []);
G__4243_4245.config(["$interpolateProvider", function(a) {
  oasysusa.profile.core.start_symbol.call(null, a, "{@");
  oasysusa.profile.core.end_symbol.call(null, a, "@}");
  return a
}]);
G__4243_4245.directive("formInput", function() {
