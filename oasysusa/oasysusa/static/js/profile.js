...
cljs.core.with_meta = function with_meta(b, c) {
  ...
  return d ? with_meta.call(null, function() {
    if(void 0 === cljs.core.t3533) {
      cljs.core.t3533 = {};
      cljs.core.t3533 = function(b, c, d, e) {
        this.meta = b;
        this.o = c;
        this.with_meta = d;
        this.meta3534 = e;
      ...
      cljs.core.t3533.cljs$lang$type = !0;
      cljs.core.t3533.cljs$lang$ctorStr = "cljs.core/t3533";
      cljs.core.t3533.cljs$lang$ctorPrWriter = function(b, c) {
        return cljs.core._write.call(null, c, "cljs.core/t3533")
      };
      var d = cljs.core.t3533.prototype, f = function(b, c) {
      ...
      cljs.core.t3533.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3533.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
...
var phone_cat = {services:{}}, G__3458_3459 = angular.module.call(null, "phonecatServices", ["ngResource"]);
G__3458_3459.factory("Phone", ["$resource", function(a) {
  return a.call(null, "app/phones/:phoneId", cljs.core.clj__GT_js.call(null, cljs.core.ObjMap.EMPTY), cljs.core.clj__GT_js.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:query", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:method", "GET", "\ufdd0:params", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:phoneId", ""], !0), "\ufdd0:isArray", !0], !0)], !0)))
}]);
phone_cat.controllers = {};
phone_cat.controllers.phone_list_ctrl = function(a, b) {
  a.phones = b.query.call(null);
  return a.orderProp = "age"
};
goog.exportSymbol("phone_cat.controllers.phone_list_ctrl", phone_cat.controllers.phone_list_ctrl);
phone_cat.controllers.phone_list_ctrl.$inject = ["$scope", "Phone"];
phone_cat.controllers.phone_detail_ctrl = function(a, b, c) {
  a.phone = c.get(cljs.core.clj__GT_js.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:phoneId", b.phoneId], !0)), function(b) {
    return a.mainImageUrl = cljs.core.first.call(null, b.images)
  });
  return a.setImage = cljs.core.partial.call(null, cljs.core.aset, a, "mainImageUrl")
};
goog.exportSymbol("phone_cat.controllers.phone_detail_ctrl", phone_cat.controllers.phone_detail_ctrl);
phone_cat.controllers.phone_detail_ctrl.$inject = ["$scope", "$routeParams", "Phone"];
phone_cat.filters = {};
...
phone_cat.app = {};
phone_cat.app.ng_route = function(a, b, c) {
  return a.when(b, cljs.core.clj__GT_js.call(null, c))
};
phone_cat.app.ng_route_otherwise = function(a, b) {
  return a.otherwise(cljs.core.clj__GT_js.call(null, b))
};
phone_cat.app.start_symbol = function(a, b) {
  return a.startSymbol(b)
};
phone_cat.app.end_symbol = function(a, b) {
  return a.endSymbol(b)
};
var G__3724_3727 = angular.module.call(null, "phonecat", ["phonecatFilters", "phonecatServices"]);
G__3724_3727.config(["$routeProvider", "$interpolateProvider", function(a, b) {
  phone_cat.app.start_symbol.call(null, b, "{@");
  phone_cat.app.end_symbol.call(null, b, "@}");
  phone_cat.app.ng_route.call(null, a, "/phones", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:templateUrl", "/partials/phone-list", "\ufdd0:controller", phone_cat.controllers.phone_list_ctrl], !0));
  phone_cat.app.ng_route.call(null, a, "/phones/:phoneId", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:templateUrl", "/partials/phone-detail", "\ufdd0:controller", phone_cat.controllers.phone_detail_ctrl], !0));
  phone_cat.app.ng_route_otherwise.call(null, a, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:redirectTo", "/phones"], !0));
  return a
}]);
