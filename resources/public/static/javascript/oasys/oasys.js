...
var oasys = {tech:{}};
oasys.tech.index = {};
oasys.tech.index.MainCtrl = function(a, b) {
  a.navigateTo = function(a) {
    b.path("/" + a)
  }
};
oasys.tech.index.setup = function() {
  angular.module("oasys.tech.index", []).config(function(a) {
    a.when("/industries", {templateUrl:"views/industries.html"}).when("/practice", {templateUrl:"views/practice.html"}).when("/staffing", {templateUrl:"views/staffing.html"}).when("/service", {templateUrl:"views/service.html"}).otherwise({redirectTo:"/service", templateUrl:"views/service.html"})
  })
};
oasys.core = {};
