...
public enum MDP {
    ...
    /**
     * This is the version of majordomo.MDP/Client we implement
     */
    C_CLIENT("MDPC01"),

    /**
     * This is the version of majordomo.MDP/Worker we implement
     */
    W_WORKER("MDPW01"),

    // majordomo.MDP/Server commands, as byte values
    W_READY(1),
    W_REQUEST(2),
    W_REPLY(3),
    W_HEARTBEAT(4),
