...
public class WorkSegments {
	...
	public static List<WorkSegments> findAllWorkSegmentses() {
        return entityManager().createQuery("SELECT o FROM WorkSegments o", WorkSegments.class).getResultList();
    }

	public static WorkSegments findWorkSegments(Integer id) {
        if (id == null) return null;
        return entityManager().find(WorkSegments.class, id);
    }

	public static List<WorkSegments> findWorkSegmentsEntries(int firstResult, int maxResults) {
