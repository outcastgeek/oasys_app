...
public class PayrollCycles {
    ...
    public static List<com.outcastgeek.domain.PayrollCycles> findAllPayrollCycleses() {
        return entityManager().createQuery("SELECT o FROM PayrollCycles o", PayrollCycles.class).getResultList();
    }

    public static com.outcastgeek.domain.PayrollCycles findPayrollCycles(Integer id) {
        if (id == null) return null;
        return entityManager().find(PayrollCycles.class, id);
    }

    public static List<com.outcastgeek.domain.PayrollCycles> findPayrollCyclesEntries(int firstResult, int maxResults) {
    ...
    @Transactional
    public com.outcastgeek.domain.PayrollCycles merge() {
        if (this.entityManager == null) this.entityManager = entityManager();
