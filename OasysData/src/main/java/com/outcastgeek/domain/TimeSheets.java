...
public class TimeSheets {
    ...
    public static List<com.outcastgeek.domain.TimeSheets> findAllTimeSheetses() {
        return entityManager().createQuery("SELECT o FROM TimeSheets o", TimeSheets.class).getResultList();
    }

    public static com.outcastgeek.domain.TimeSheets findTimeSheets(Integer id) {
        if (id == null) return null;
        return entityManager().find(TimeSheets.class, id);
    }

    public static List<com.outcastgeek.domain.TimeSheets> findTimeSheetsEntries(int firstResult, int maxResults) {
    ...
    @Transactional
    public com.outcastgeek.domain.TimeSheets merge() {
        if (this.entityManager == null) this.entityManager = entityManager();
