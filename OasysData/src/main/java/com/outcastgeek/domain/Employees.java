...
public class Employees {
    ...
    public static List<com.outcastgeek.domain.Employees> findAllEmployeeses() {
        return entityManager().createQuery("SELECT o FROM Employees o", Employees.class).getResultList();
    }

    public static com.outcastgeek.domain.Employees findEmployees(Integer id) {
        if (id == null) return null;
        return entityManager().find(Employees.class, id);
    }

    public static List<com.outcastgeek.domain.Employees> findEmployeesEntries(int firstResult, int maxResults) {
    ...
    @Transactional
    public com.outcastgeek.domain.Employees merge() {
        if (this.entityManager == null) this.entityManager = entityManager();
